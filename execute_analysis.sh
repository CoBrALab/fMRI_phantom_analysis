...
print_help()
{
	...
	printf 'Usage: %s [--output_path <arg>] [--repetition_time <arg>] [--input_roi <arg>] [--desired_slice <arg>] [--weisskoff_max_roi_width <arg>] [-h|--help] <input_epi>\n' "$0"
...
python3.8 $scriptdir/phantom_analysis_functions.py $_arg_input_epi $output_path_prefix $_arg_repetition_time $_arg_input_roi $_arg_desired_slice $_arg_weisskoff_max_roi_width
